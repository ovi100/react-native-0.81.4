...
import Approvals from '../../screens/dashboard/approvals/Approvals';
import DocumentDetails from '../../screens/dashboard/approvals/DocumentDetails';
...
const ApprovalNavigator = () => {
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen
        name="ApprovalsDocumentDetails"
        component={DocumentDetails}
        options={{
          headerTitle: 'Document Details',
          ...screenSettings
        }}
        initialParams={{ screen: "Approvals" }}
      />
    </Stack.Navigator>
  );
};
